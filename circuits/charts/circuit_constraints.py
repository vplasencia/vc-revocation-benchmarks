...
plt.plot(tree_depth, leanimt, marker='o', label="LeanIMT")
plt.plot(tree_depth, smt, marker='s', label="SMT")
...
plt.plot(tree_depth, ratio, marker='d', label="SMT / LeanIMT")
plt.axhline(1.0, linestyle="--", alpha=0.7)  # reference line
